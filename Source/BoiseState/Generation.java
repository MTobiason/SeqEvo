...
public class Generation
{
   ...
   private static Integer IntramolecularW;
   private static Integer IntermolecularW;
   ...
   public Generation(DomainPool IncomingDomainAncestor, StrandPool IncomingStrandAncestor)
   {
      ...
      //Generate/set reference Positions
      ...
      //MTout.log("Creating Reference Position Scores");
      //intraScores = new ConcurrentHashMap<referencePosition, Long>();
      //interScores = new ConcurrentHashMap<referencePosition, Long>();
      //updateScores();
...
//         System.out.print(ess[si2][Math.min( sl[si2],rp-i)]);  //print the elements of strand 2 on a line.
   ...
   {
      tfs = getSFS().multiply(BigInteger.valueOf(IntramolecularW.longValue())).add(getNFS().multiply(BigInteger.valueOf(IntermolecularW.longValue())));
      tfsUpToDate =true;
   }
