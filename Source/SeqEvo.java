...
public class SeqEvo
{
   ...
   private static final String version = "1.6";// 2019-04-01;
   ...
   //********************************************
	...
	public static void main(String[] args) throws Exception
	{
      ...
      if(Lineage.getGenerationReporting() == true) // if generaton trajectory reporting is active
      {
      ...
      if(Lineage.getCycleReporting() == true) // if generaton trajectory reporting is active
      {
      ...
      if(Lineage.getLogCycleReporting() == true) // if generaton trajectory reporting is active
      {
   ...
   public static void importSettings( String PFilePath ) throws Exception
   {
      ...
      GTOFilePath = "disabled"; //GTO: Generation-Trajectory-Output 
      CTOFilePath = "disabled"; //log-Cycle-Trajectory-Output
